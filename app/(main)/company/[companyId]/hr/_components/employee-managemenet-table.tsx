...
import { ArrowLeft, ArrowRight, Eye, HandCoins, Search, SquarePen, Trash2, User } from "lucide-react";
...
export default function EmployeeManagementTable() {
    ...
    const handleEmployeePerformance = (employeeId: string) => {
        router.push(`/company/${companyId}/admin/manage-employee/${employeeId}/performance`);
    }
                                ...
                                <TableCell className="flex justify-end">
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                                <Button 
                                                variant="icon" 
                                                onClick={() => handleEmployeePerformance(employee.id)}
                                                >
                                                    <Eye />
                                                </Button>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>View Employee Performance</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TableCell>
                            </TableRow>
